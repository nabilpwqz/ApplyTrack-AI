...
import { Mail, Lock, User as UserIcon, ArrowRight, UserCheck, Sparkles } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="glass-card p-4 rounded-2xl border border-amber-500/20 space-y-2.5 text-center">
          ...
          <p className="text-[10px] text-slate-300 leading-relaxed">
            Want to explore features first? Launch the pre-seeded Guest workspace with 42 active applications.
          </p>
          <button 
